...
class BinData(object):
    ...
    def readStr(self, size, encoding='ascii'):
        return str(self.unpack_nocache('{}s'.format(size))[0], encoding=encoding)

    def readBytes(self, size):
        return bytes(self.unpack_nocache('{}B'.format(size)))
    ...
    def dataSizeLeft(self): return self.dataSize() - self.tell()
